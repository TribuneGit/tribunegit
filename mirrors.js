...
const PAGE_DEFS = {
  ...
  index: {
    ...
    build() {
      ...
      let md = fm(
        ...
        'Concierge healthcare delivered to your home. In-home primary care, IV therapy, Botox, medical weight loss, fertility, and more. Serving [CITY] and all of [COUNTY], FL.',
        `${SITE}/`
      );
      ...
      md += `Concierge Healthcare. We Come to You. Free Telehealth Meet & Greet with [PROVIDER NAME] — no commitment, no waiting room.\n\n`;
      ...
      md += `All services delivered to your home, office, or via telehealth:\n\n`;
      md += `| Service | Starting Price | Details |\n|---|---|---|\n`;
      md += `| In-Home Primary Care | $100+ | [/services/in-home-primary-care.md](${SITE}/services/in-home-primary-care.md) |\n`;
      md += `| Urgent Care at Home | $100+ | [/services/urgent-care.md](${SITE}/services/urgent-care.md) |\n`;
      md += `| Telehealth | $60+ | [/services/telehealth.md](${SITE}/services/telehealth.md) |\n`;
      md += `| Mobile IV Therapy | $100+ | [/services/iv-therapy.md](${SITE}/services/iv-therapy.md) |\n`;
      md += `| Botox & Dysport | — | [/services/botox.md](${SITE}/services/botox.md) |\n`;
      md += `| Dermal Fillers | — | [/services/dermal-fillers.md](${SITE}/services/dermal-fillers.md) |\n`;
      md += `| Microneedling | — | [/services/microneedling.md](${SITE}/services/microneedling.md) |\n`;
      md += `| PRP Vampire Facial | — | [/services/prp-facial.md](${SITE}/services/prp-facial.md) |\n`;
      md += `| PRP Hair Restoration | $300+ | [/services/prp-hair.md](${SITE}/services/prp-hair.md) |\n`;
      md += `| Medical Weight Loss | $300+ | [/services/weight-loss.md](${SITE}/services/weight-loss.md) |\n`;
      md += `| Peptide Therapy | — | [/services/peptides.md](${SITE}/services/peptides.md) |\n`;
      md += `| Hormone Replacement (HRT) | — | [/services/hormone-replacement-therapy.md](${SITE}/services/hormone-replacement-therapy.md) |\n`;
      md += `| Cryotherapy | — | [/services/cryotherapy.md](${SITE}/services/cryotherapy.md) |\n`;
      md += `| B12 Injections | — | [/services/b12-injections.md](${SITE}/services/b12-injections.md) |\n`;
      md += `| Fertility Care | — | [/services/fertility.md](${SITE}/services/fertility.md) |\n`;
      md += `| Skilled Nursing | — | [/services/skilled-nursing.md](${SITE}/services/skilled-nursing.md) |\n`;
      md += `| Wellness | — | [/services/wellness.md](${SITE}/services/wellness.md) |\n`;
      md += `| IV Membership | $149–$549/mo | [/services/membership.md](${SITE}/services/membership.md) |\n\n`;
      ...
      md += `**Step 1: Book Your Free Meet & Greet** — Schedule a free telehealth session with [PROVIDER NAME]. No commitment.\n\n`;
      md += `**Step 2: Receive Your Custom Plan** — [PROVIDER NAME] evaluates, listens, and builds a plan around your life.\n\n`;
      md += `**Step 3: Care Comes to You** — At-home, in-office, or telehealth. Same provider every time.\n\n`;
      ...
      md += `In-Home Primary Care $100+ | Telehealth $60+ | Weight Loss $300+ | IV Therapy $100+ | IV Membership $149–$549/mo | Cosmetics $100+\n\nInsurance not accepted (some lab exceptions). Cash, Visa, Mastercard, Amex, Discover. Payment plans available.\n\n`;
      ...
      md += `## Contact\n\n**Keywords:** ${mergeSeo(['book beyond concierge healthcare wellington fl','contact gabrielle radabaugh','schedule in-home visit palm beach county','free telehealth consultation florida'], slug, 'contact')}\n\n`;
  ...
  about: {
    ...
    build() {
      ...
      md += `My name is [PROVIDER NAME], a certified Nurse Practitioner with over six years of experience in healthcare. I live in [CITY] and service all of [COUNTY], FL. I am dedicated to providing comprehensive, patient-centered care. I specialize in family medicine, aesthetic procedures, weight loss, and peptide therapy.\n\n`;
  ...
  faqs: {
    ...
    build() {
      const slug = 'faqs';
      let md = fm(
        'FAQs | Concierge Healthcare [CITY], FL | [COMPANY NAME]',
      ...
      md += `**Q: What is [COMPANY NAME]?**  \nA: [COMPANY NAME] ([COMPANY]) is a mobile concierge medical practice owned and operated by [PROVIDER NAME], [CREDENTIALS]. We deliver in-home primary care, IV therapy, aesthetics, weight loss, fertility care, and more directly to patients across [CITY] and [COUNTY], FL.\n\n`;
      ...
      md += `**Q: What areas do you serve?**  \nA: [CITY], [CITY], [CITY], [CITY], [CITY], and all of [COUNTY]. Telehealth available statewide in [STATE].\n\n`;
      ...
      md += `**Q: What services do you offer?**  \nA: In-home primary care, urgent care, telehealth, mobile IV therapy, Botox & Dysport, dermal fillers, microneedling, PRP facial/hair, medical weight loss (semaglutide/tirzepatide), peptide therapy, HRT, cryotherapy, B12 injections, fertility care, skilled nursing, wellness services, and IV memberships.\n\n`;
      ...
      md += `## Pricing & Payment\n\n**Keywords:** ${mergeSeo(['beyond concierge healthcare pricing faq','how much does in-home healthcare cost wellington','concierge healthcare payment plans florida','nurse practitioner visit cost palm beach'], slug, 'pricing')}\n\n`;
      md += `**Q: How much do services cost?**  \nA: Starting prices: In-Home Primary Care $100+, Telehealth $60+, Weight Loss $300+, IV Therapy $100+, Cosmetics $100+. See /pricing.md for the full schedule.\n\n`;
      md += `**Q: What payment methods do you accept?**  \nA: Cash, Visa, Mastercard, American Express, Discover. Payment plans available.\n\n`;
      md += `**Q: What is the membership discount?**  \nA: IV Therapy members save 25% on all other [COMPANY] services. Membership plans: Basic $149/mo, Plus $349/mo, Elite $549/mo.\n\n`;
      ...
      md += `**Q: How do I book?**  \nA: Call or text ${PHONE}, email [EMAIL], or book online at ${SITE}/book-now.html. New patients get a free telehealth meet & greet.\n\n`;
      ...
      md += `**Q: Is the first consultation really free?**  \nA: Yes. New patients receive a free telehealth meet & greet valued at $100.\n\n`;
  ...
  pricing: {
    ...
    build() {
      ...
      let md = fm(
        ...
        'Transparent pricing for concierge healthcare in [CITY] and [COUNTY]. In-home primary care, IV therapy, medical weight loss, aesthetics, and membership plans.',
        `${SITE}/pricing.html`
      );
      ...
      md += `| In-Home Primary Care | $100+ |\n`;
      md += `| Telehealth Visit | $60+ |\n`;
      md += `| Medical Weight Loss Program | $300+ |\n`;
      md += `| Mobile IV Therapy (per session) | $100+ |\n`;
      md += `| PRP Hair Restoration | $300+ |\n`;
      md += `| Cosmetic Procedures (general) | $100+ |\n\n`;
      md += `Insurance not accepted (some lab exceptions). Payment: Cash, Visa, Mastercard, Amex, Discover. Payment plans available.\n\n`;

      md += `## IV Therapy Membership Plans\n\n**Keywords:** ${mergeSeo(['iv therapy membership wellington fl','beyond concierge membership plans palm beach','monthly iv therapy membership florida','25% off healthcare membership'], slug, 'membership')}\n\n`;
      md += `| Plan | Monthly Price | IV Sessions | Savings |\n|---|---|---|---|\n`;
      ...
      md += `All membership plans include 25% off all other [COMPANY] services. No contracts. Cancel anytime.\n\n`;
  ...
  gabby: {
    ...
    build() {
      ...
      md += `## Credentials\n\n**Keywords:** ${mergeSeo(['gabrielle radabaugh arnp license florida','fnp-c board certification','aanp membership nurse practitioner','master of science south university fnp'], slug, 'credentials')}\n\n`;
  ...
  savings: {
    ...
    build() {
      const slug = 'savings';
      let md = fm(
        'Save on Concierge Healthcare | Membership Plans | [COMPANY NAME]',
        'Save up to 25% on all [COMPANY] services with an IV Therapy membership. Basic, Plus, and Elite monthly plans. [CITY] and [COUNTY], FL.',
        `${SITE}/savings.html`
      );
      md += `# Save on Concierge Healthcare — Membership Plans\n\n---\n\n`;

      md += `## Save with Membership\n\n**Keywords:** ${mergeSeo(['save on healthcare wellington fl','beyond concierge healthcare membership discount','iv therapy membership 25% off palm beach','monthly healthcare plan florida'], slug, 'membership')}\n\n`;
      md += `Join an IV Therapy membership plan and save 25% on all other [COMPANY] services. No contracts. Cancel anytime.\n\n`;
      ...
      md += `## Free New Patient Offer\n\n**Keywords:** ${mergeSeo(['free telehealth consultation wellington fl','new patient beyond concierge healthcare','free meet and greet nurse practitioner palm beach','first visit free concierge healthcare florida'], slug, 'hero')}\n\n`;
      md += `New patients receive a free Telehealth Meet & Greet with [PROVIDER NAME] — valued at $100. No commitment required.\n\nBook: ${SITE}/book-now.html\n\n`;
  ...
  'locations-wellington': {
    ...
    build() {
      ...
      let md = fm(
        ...
        'Concierge healthcare delivered to your home in [CITY], FL. In-home primary care, IV therapy, Botox, weight loss, and more from [PROVIDER NAME], [CREDENTIALS].',
        `${SITE}/locations/wellington-fl.html`
      );
      md += `# Concierge Healthcare in [CITY], FL\n\n`;
      md += `> [COMPANY NAME] delivers in-home and telehealth services throughout [CITY], FL and surrounding [COUNTY] communities.\n\n---\n\n`;

      md += `## Services in [CITY], FL\n\n**Keywords:** ${mergeSeo(['concierge healthcare wellington florida','in-home primary care wellington fl','mobile iv therapy wellington fl','botox wellington florida','medical weight loss wellington fl','nurse practitioner wellington fl','home healthcare wellington palm beach'], slug, 'services')}\n\n`;
      ...
      md += `In-Home Primary Care · Urgent Care · Telehealth · Mobile IV Therapy · Botox & Dysport · Dermal Fillers · Microneedling · PRP Facial/Hair · Medical Weight Loss · Peptides · HRT · Cryotherapy · B12 Injections · Fertility Care · Skilled Nursing · Wellness\n\n`;

      md += `## About [CITY], FL Service Area\n\n**Keywords:** ${mergeSeo(['wellington fl healthcare provider','wellington florida nurse practitioner','beyond concierge healthcare wellington service area','wellington palm beach county medical care'], slug, 'area')}\n\n`;
  ...
  'locations-loxahatchee': {
    ...
    build() {
      ...
      md += `[PROVIDER NAME] lives in [CITY] and serves the community directly. All [COMPANY] services available: primary care, IV therapy, aesthetics, weight loss, peptides, and more.\n\n`;

      md += `## About [CITY] Service Area\n\n**Keywords:** ${mergeSeo(['loxahatchee fl healthcare provider','loxahatchee nurse practitioner','beyond concierge healthcare loxahatchee','loxahatchee palm beach county medical care'], slug, 'area')}\n\n`;
  ...
  // ------ services/iv-memberships.html --------------------------------------
  'iv-memberships': {
    output: 'services/iv-memberships.md',
    build() {
      const slug = 'iv-memberships';
      let md = fm(
        'IV Therapy Memberships in [CITY], FL | [COMPANY NAME]',
        'Save up to 25% on all [COMPANY] services with a monthly IV therapy membership. Basic, Plus, and Elite plans. Mobile IV therapy delivered to your home in [CITY] and [COUNTY], FL.',
        `${SITE}/services/iv-memberships.html`
      );
      md += `# IV Therapy Memberships — [CITY], FL\n\n`;
      md += `> Regular IV therapy. Real savings. [PROVIDER NAME] delivers every session to your home, office, or event.\n\n---\n\n`;

      md += `## Overview\n\n**Keywords:** ${mergeSeo(['iv therapy membership wellington fl','monthly iv therapy plan palm beach county','iv membership 25% off all services','beyond concierge iv membership florida','iv drip subscription wellington fl'], slug, 'hero')}\n\n`;
      md += `Join a monthly IV membership and save 25% on all other [COMPANY] services. No contracts. Cancel anytime. [PROVIDER NAME] personally delivers every session.\n\n`;

      md += `## Membership Plans\n\n**Keywords:** ${mergeSeo(['iv membership plans pricing wellington fl','basic plus elite iv membership palm beach','monthly iv drip plan cost florida','iv therapy subscription plans near me'], slug, 'plans')}\n\n`;
      md += `| Plan | Price | Sessions/mo | Savings |\n|---|---|---|---|\n`;
      ...
      md += `## Why Membership\n\n**Keywords:** ${mergeSeo(['benefits of iv therapy membership','why join iv therapy plan wellington','iv membership vs single session palm beach','regular iv therapy benefits florida'], slug, 'why')}\n\n`;
      md += `- 25% off IV sessions plus all other [COMPANY] services\n- Priority scheduling\n- Same trusted provider every session\n- We come to you — home, office, or event\n- Ideal for energy, immunity, recovery, and anti-aging routines\n\n`;

      md += `## How to Join\n\n**Keywords:** ${mergeSeo(['join iv membership wellington fl','sign up iv therapy plan palm beach county','book iv membership beyond concierge healthcare'], slug, 'steps')}\n\n`;
  ...
  'iv-basics': {
    ...
    build() {
      ...
      let md = fm(
        ...
        'Simple mobile IV therapy packages delivered to your home in [CITY] and [COUNTY]. Hydration, immune boost, energy, and more. Starting at $100+.',
        `${SITE}/services/iv-basics.html`
      );
      md += `# Basic IV Packages — [CITY], FL\n\n`;
      md += `> Simple, effective IV therapy delivered to your home. No complicated menus — just the core drips that work.\n\n---\n\n`;

      md += `## Overview\n\n**Keywords:** ${mergeSeo(['basic iv packages wellington fl','simple iv therapy palm beach county','iv drip packages near me florida','affordable iv therapy wellington fl','starter iv package mobile palm beach'], slug, 'hero')}\n\n`;
      md += `[COMPANY] Basic IV Packages cover the most-requested drip infusions: hydration, immune support, energy and focus, hangover recovery, and general wellness. All delivered to your location by [PROVIDER NAME]. Starting at $100+.\n\n`;

      md += `## Package Options\n\n**Keywords:** ${mergeSeo(['iv therapy package options wellington','hydration drip palm beach county','immune boost iv wellington fl','hangover iv therapy palm beach','energy iv drip florida'], slug, 'packages')}\n\n`;
      md += `- Hydration Drip — rehydrate fast, no downtime\n- Immune Boost — vitamin C, zinc, B-complex blend\n- Energy & Focus — B12, B-complex, magnesium\n- Hangover Recovery — fluids, anti-nausea, vitamins\n- Myers Cocktail — the all-around foundation drip\n\nStarting at $100+ per session. 25% off with membership.\n\n`;

      md += `## How It Works\n\n**Keywords:** ${mergeSeo(['how mobile iv therapy works wellington','basic iv session process palm beach county','iv appointment at home florida','book iv drip near me wellington'], slug, 'how')}\n\n`;
  ...
  'iv-cocktails': {
    ...
    build() {
      ...
      let md = fm(
        ...
        'Custom IV cocktail blends for beauty, NAD+, weight loss support, and more. Mobile delivery to your home in [CITY] and [COUNTY], FL.',
        `${SITE}/services/iv-cocktails.html`
      );
      md += `# IV Cocktails & Specialty Drips — [CITY], FL\n\n`;
      md += `> Custom IV blends built for results. Specialty drips beyond the basics — beauty, NAD+, weight loss support, and more.\n\n---\n\n`;

      md += `## Overview\n\n**Keywords:** ${mergeSeo(['iv cocktails wellington fl','specialty iv drips palm beach county','custom iv blend florida mobile','nad+ iv cocktail wellington','beauty iv drip palm beach county fl'], slug, 'hero')}\n\n`;
      md += `[COMPANY] IV Cocktails are specialty blends designed for specific goals: anti-aging and beauty, NAD+ cellular renewal, weight loss support, pregnancy and morning sickness, and more. All delivered to your home by [PROVIDER NAME].\n\n`;

      md += `## Cocktail Menu\n\n**Keywords:** ${mergeSeo(['iv cocktail menu wellington fl','beauty iv drip florida','nad+ iv therapy palm beach county','myers cocktail wellington fl','weight loss iv drip florida','morning sickness iv therapy palm beach'], slug, 'menu')}\n\n`;
      md += `- **Beauty** — glutathione, vitamin C, biotin for skin, hair, and nails\n- **NAD+** — nicotinamide adenine dinucleotide for cellular energy and anti-aging\n- **Weight Loss Support** — B12, L-carnitine, MIC blend\n- **Morning Sickness / Pregnancy** — safe anti-nausea, fluids, B6\n- **Myers Cocktail** — full-spectrum immune + energy foundation\n- **High-Dose Vitamin C** — antioxidant and immune support\n- **Jet Lag & Travel Recovery** — rapid rehydration and reset\n\n25% off all cocktails with IV membership.\n\n`;
  ...
  'iv-extras': {
    ...
    build() {
      ...
      let md = fm(
        'IV Add-Ons & Boosters in [CITY], FL | [COMPANY NAME]',
        'Enhance any IV session with targeted add-ons: glutathione, zinc, magnesium, B-complex, and more. Mobile IV add-ons in [CITY] and [COUNTY].',
        `${SITE}/services/iv-extras.html`
      );
      md += `# IV Add-Ons & Boosters — [CITY], FL\n\n`;
      md += `> Add a targeted booster to any IV session. $25 each. Elite members get 2 free add-ons per session.\n\n---\n\n`;

      md += `## Overview\n\n**Keywords:** ${mergeSeo(['iv add-ons wellington fl','iv boosters palm beach county','glutathione push wellington fl','iv extras near me florida','vitamin iv booster palm beach'], slug, 'hero')}\n\n`;
      md += `[COMPANY] IV add-ons are individual ingredients you can add to any base drip or cocktail. Each add-on is $25. Elite membership members receive 2 free add-ons per session.\n\n`;

      md += `## Available Add-Ons\n\n**Keywords:** ${mergeSeo(['glutathione iv push wellington fl','zinc magnesium iv add-on palm beach','b-complex iv booster florida','iv vitamin push near me wellington','extra b12 iv shot palm beach county'], slug, 'menu')}\n\n`;
      md += `- **Glutathione Push** — master antioxidant, skin brightening, detox ($25)\n- **Zinc & Magnesium** — immune support, muscle function ($25)\n- **Extra B-Complex** — energy, metabolism, nervous system ($25)\n- **Extra B12** — energy and focus boost ($25)\n- **Extra Vitamin C** — immune boost and antioxidant ($25)\n\nElite IV membership: 2 free add-ons per session included.\n\n`;
  ...
  // ------ services/iv-nad.html ---------------------------------------------
  'iv-nad': {
    output: 'services/iv-nad.md',
    build() {
      const slug = 'iv-nad';
      let md = fm(
        'NAD+ IV Therapy in [CITY], FL | [COMPANY NAME]',
        'Mobile NAD+ IV therapy delivered to your home in [CITY] and [COUNTY]. Cellular energy, anti-aging, brain clarity, and recovery support from [PROVIDER NAME], [CREDENTIALS].',
        `${SITE}/services/iv-nad.html`
      );
      md += `# NAD+ IV Therapy — [CITY], FL\n\n`;
      md += `> Nicotinamide Adenine Dinucleotide (NAD+) IV therapy for cellular renewal, energy, brain clarity, and recovery. Delivered to your home by [PROVIDER NAME].\n\n---\n\n`;

      md += `## What is NAD+ IV Therapy?\n\n**Keywords:** ${mergeSeo(['nad+ iv therapy wellington fl','nad+ infusion palm beach county','nicotinamide adenine dinucleotide iv florida','nad+ iv anti-aging wellington','mobile nad+ therapy palm beach fl'], slug, 'hero')}\n\n`;
      md += `NAD+ (nicotinamide adenine dinucleotide) is a coenzyme essential for cellular energy production, DNA repair, and metabolic function. IV delivery bypasses digestion and delivers NAD+ directly to cells — far more effective than oral supplements.\n\n`;

      md += `## Benefits\n\n**Keywords:** ${mergeSeo(['nad+ iv benefits wellington fl','nad+ therapy for energy florida','nad+ brain clarity palm beach county','nad+ anti-aging iv drip florida','nad+ addiction recovery iv therapy'], slug, 'benefits')}\n\n`;
      md += `Clients report: sustained energy without stimulants · improved mental clarity and focus · reduced brain fog · anti-aging cellular support · improved athletic recovery · support for addiction recovery · better sleep quality.\n\n`;

      md += `## How It Works\n\n**Keywords:** ${mergeSeo(['how nad+ iv therapy works','nad+ iv session process wellington fl','how long does nad+ iv take','nad+ iv dose palm beach county florida'], slug, 'how')}\n\n`;
      ...
      md += `## Provider Note\n\n**Keywords:** ${mergeSeo(['gabrielle radabaugh nad+ therapy','nurse practitioner nad+ wellington fl','board certified nad+ iv provider florida'], slug, 'provider')}\n\n`;
      md += `All NAD+ sessions are administered by [PROVIDER NAME], [CREDENTIALS]. She evaluates your health history before your first session and adjusts dosing based on your response.\n\n*[PROVIDER NAME], [CREDENTIALS]. Board Certified Family Nurse Practitioner. AANP Member.*\n\n`;
  ...
  'book-now': {
    ...
    build() {
      ...
      let md = fm(
        ...
        'Book a free telehealth meet & greet or schedule any [COMPANY] service. In-home primary care, IV therapy, Botox, weight loss, and more in [CITY] and [COUNTY], FL.',
        `${SITE}/book-now.html`
      );
      md += `# Book a Consultation — [COMPANY NAME]\n\n`;
      md += `> Start with a free telehealth meet & greet. No commitment. [PROVIDER NAME] will answer your questions and build a plan.\n\n---\n\n`;
      ...
      md += `## Services Available to Book\n\n**Keywords:** ${mergeSeo(['book iv therapy palm beach county','schedule botox wellington fl','book weight loss consultation florida','book in-home primary care wellington'], slug, 'services')}\n\n`;
      md += `In-Home Primary Care · Urgent Care · Telehealth · Mobile IV Therapy · Botox & Dysport · Dermal Fillers · Microneedling · PRP Facial/Hair · Medical Weight Loss · Peptides · HRT · Cryotherapy · B12 Injections · Fertility · Skilled Nursing · Wellness  \n\nSee full service list: ${SITE}/index.md\n\n`;
  ...
  // ------ membership.html (root) ------------------------------------------
  'membership-root': {
    output: 'membership.md',
    build() {
      const slug = 'membership-root';
      let md = fm(
        'IV Therapy Membership [CITY], FL | [COMPANY NAME]',
        'Monthly IV therapy membership plans with 25% savings on all [COMPANY] services. Basic, Plus, and Elite tiers. Mobile delivery in [CITY] and [COUNTY], FL.',
        `${SITE}/membership.html`
      );
      md += `# IV Therapy Membership — [CITY], FL\n\n`;
      md += `> Join a monthly plan. Save 25% on all [COMPANY] services. [PROVIDER NAME] delivers every session to your door.\n\n---\n\n`;

      md += `## Plans\n\n**Keywords:** ${mergeSeo(['iv therapy membership wellington fl','monthly healthcare membership palm beach county','25% off all services iv membership florida','iv membership plan near me wellington'], slug, 'plans')}\n\n`;
      md += `| Plan | Price | Sessions/mo | Savings |\n|---|---|---|---|\n`;
      md += `| Basic | $149/mo | 1 IV/mo | 25% off all [COMPANY] services |\n`;
      md += `| Plus | $349/mo | 3 IVs/mo | 25% off all [COMPANY] services |\n`;
      md += `| Elite | $549/mo | 5 IVs/mo | 25% off all [COMPANY] services + 2 free add-ons/session |\n\n`;
      md += `No contracts. Cancel anytime. See also: [/services/iv-memberships.md](${SITE}/services/iv-memberships.md)\n\n`;
  ...
  'locations-west-palm-beach': {
    ...
    build() {
      ...
      let md = fm(
        'Concierge Healthcare in [CITY], FL | [COMPANY NAME]',
        'In-home and telehealth concierge healthcare in [CITY], FL. All [COMPANY] services delivered to your home by [PROVIDER NAME], [CREDENTIALS].',
        `${SITE}/locations/west-palm-beach-fl.html`
      );
      md += `# Concierge Healthcare in [CITY], FL\n\n---\n\n`;

      md += `## Services in [CITY], FL\n\n**Keywords:** ${mergeSeo(['concierge healthcare west palm beach florida','in-home nurse practitioner west palm beach fl','mobile iv therapy west palm beach','botox west palm beach fl','home visit healthcare west palm beach palm beach county'], slug, 'services')}\n\n`;
      md += `All [COMPANY] services available in [CITY]. [PROVIDER NAME] delivers in-home primary care, IV therapy, aesthetics, weight loss, and more throughout [CITY] and greater [COUNTY].\n\n`;

      md += `## Service Area Notes\n\n**Keywords:** ${mergeSeo(['west palm beach fl healthcare provider','west palm beach nurse practitioner','beyond concierge healthcare west palm beach','west palm beach palm beach county medical care'], slug, 'area')}\n\n`;
  ...
  'service-area': {
    ...
    build() {
      ...
      let md = fm(
        'Service Area | [COMPANY NAME] | [CITY], [COUNTY], FL',
        '[COMPANY NAME] serves [CITY], [CITY], [CITY], [CITY], [CITY], [CITY], and all of [COUNTY], FL. Telehealth statewide.',
        `${SITE}/about/service-area.html`
      );
      md += `# [COMPANY NAME] — Service Area\n\n---\n\n`;

      md += `## Locations Served\n\n**Keywords:** ${mergeSeo(['beyond concierge healthcare service area florida','in-home healthcare palm beach county cities','mobile nurse practitioner cities served','concierge healthcare coverage palm beach fl','telehealth florida statewide nurse practitioner'], slug, 'area')}\n\n`;
      md += `**In-Home & On-Site Service Area:**  \n[CITY] · [CITY] · [CITY] · [CITY] · [CITY] · [CITY] · [COUNTY] Gardens · Lake Worth · Boynton Beach · Boca Raton · and all of [COUNTY], FL\n\n**Telehealth:** Available statewide across [STATE].\n\n`;
  ...
  'services-index': {
    ...
    build() {
      ...
      let md = fm(
        ...
        'Full list of concierge healthcare services delivered to your home in [CITY] and [COUNTY]. Primary care, IV therapy, aesthetics, weight loss, fertility, and more.',
        `${SITE}/services/`
      );
      md += `# All [COMPANY] Services — [CITY], FL\n\n`;
      md += `> Every service below is delivered to your home, office, or via telehealth across [CITY] and [COUNTY].\n\n---\n\n`;
      ...
      const services = [
        ['IV Therapy', 'iv-therapy'], ['IV Memberships', 'iv-memberships'], ['Basic IV Packages', 'iv-basics'],
        ['IV Cocktails', 'iv-cocktails'], ['IV Add-Ons', 'iv-extras'], ['NAD+ IV Therapy', 'iv-nad'],
        ['Botox & Dysport', 'botox'], ['Dermal Fillers', 'dermal-fillers'], ['Microneedling', 'microneedling'],
        ['PRP Vampire Facial', 'prp-facial'], ['PRP Hair Restoration', 'prp-hair'],
        ['Medical Weight Loss', 'weight-loss'], ['Peptide Therapy', 'peptides'],
        ['Hormone Replacement (HRT)', 'hormone-replacement-therapy'], ['Cryotherapy', 'cryotherapy'],
        ['B12 Injections', 'b12-injections'], ['Fertility Care', 'fertility'],
        ['In-Home Primary Care', 'in-home-primary-care'], ['Urgent Care at Home', 'urgent-care'],
        ['Telehealth', 'telehealth'], ['Skilled Nursing', 'skilled-nursing'],
        ['Wellness', 'wellness'], ['Membership Plans', 'membership'],
      ];
  ...
  'locations-royal-palm-beach': {
    ...
    build() {
      ...
      md += `## Services in [CITY], FL\n\n**Keywords:** ${mergeSeo(['concierge healthcare royal palm beach florida','in-home nurse practitioner royal palm beach fl','mobile iv therapy royal palm beach','botox royal palm beach fl','healthcare delivery royal palm beach palm beach county'], slug, 'services')}\n\n`;
